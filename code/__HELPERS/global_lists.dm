...
var/global/list/whitelisted_species = list(SPECIES_HUMAN,SPECIES_KIDAN) // Species that require a whitelist check.
var/global/list/playable_species = list(SPECIES_HUMAN,SPECIES_KIDAN)    // A list of ALL playable species, whitelisted, latejoin or otherwise.
